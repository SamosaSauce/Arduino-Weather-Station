...
int brTempValue1 = 20;
int brTempValue2 = 25;
int brHumidityValue1 = 35;
int brHumidityValue2 = 45;
...
void loop()
{
  ...
  if (DHT.getTemperature()/10>=brTempValue1 && DHT.getTemperature()/10<=brTempValue2){
  ...
  if (DHT.getHumidity()/10>=brHumidityValue1 && DHT.getHumidity()/10<=brHumidityValue2){
